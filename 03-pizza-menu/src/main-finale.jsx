...
// Rendering Lists ->  to setting classes and text conditionally
...
// array of data we want to render
const pizzaData = [
  {
    name: "Focaccia",
...
function Pizza({ pizzaObj }) {
  ...
  return (
    ////settling classes and text conditionally
